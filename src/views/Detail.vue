        ...
        <div class="col s12 m6">
          <div class="card" :class="{
            ...
            <div class="card-body dark-grey-text">
              ...
              <p>{{'Category'|localize}}: <small>{{record.categoryName}}</small></p>
              <p>{{'Amount'|localize}}: <small>{{record.amount | currency}}</small></p>
              <p>{{'Description'|localize}}: <small>{{record.description}}</small></p>
              <p>{{'Recycling_Type'|localize}}: <small>{{record.recyclingType}}</small></p>
              <p>{{'Precaution_Title'|localize}}: <small>{{record.precaution}}</small></p>
            </div>
